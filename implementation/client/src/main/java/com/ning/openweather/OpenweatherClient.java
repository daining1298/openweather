...
public class OpenweatherClient {
	final static String OPEN_WEATHER_URL = "http://localhost:8080?weather?location=";
	...
	public static void main(String[] args) throws IOException {
        ...
        location = console.readLine("Please enter location : ");  
        ...
        while (!parser.isClosed()) {
            ...
            if (JsonToken.FIELD_NAME.equals(token) && "currentTemperature".equals(parser.getCurrentName())) {
            	...
            	System.out.println(location + "'s current temperature is "+parser.getText());
            }
        }
	}
}
